...
3. Read existing materials (see `_bmad-output/_progress/wds-project-outline.yaml: existing_materials`)

**File naming:** Number all documents with a two-digit prefix: `01-product-brief.md`, `02-content-language.md`, etc. Platform Requirements is always last. Update the Documents table below as each file is created.
